...
void CPETBoxControlUIDlg::OnBnClickedButtonFpgaReset()
{
	if (m_VHS_Brd_Init_Sucessful)
	{
		...
		SetDlgItemText(IDC_STATIC_System_Information,"FPGA reset (not used)");
	}
...
//	iStatus = Vhsadac16_FpgaLoad(m_hVHSdevice,(UCHAR*)bitFileName); //maybe can't do this with Nutaq
	...
	//init clock   //maybe can't do this with Nutaq
