...
#ifndef   monitorManagement_H
#define   monitorManagement_H

int  monitorManagementInitialization(void);
void monitorManagementTermination(void);   
int  monitoringThread(void *functionData);
