...
#ifndef communicationsManagement_H
#define communicationsManagement_H

int  communicationsInitialization(void);
void communicationsTermination(void);
void CVICALLBACK reconnect_CB (int menuBar, int menuItem, void *callbackData, int panel);
#endif
